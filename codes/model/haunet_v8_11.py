...
def make_model(args, parent=False):
    return HAUNet(up_scale=args.scale[0], width=128, enc_blk_nums=[5,5],dec_blk_nums=[5,5],middle_blk_num=10)
...
class S_CEMBlock(nn.Module):
    ...
    def forward(self, inp):
        ...
        # y = inp + self.beta * conv_x + xs * self.beta2
...
if __name__ == '__main__':
    ...
    net = HAUNet(up_scale=4, width=128, enc_blk_nums=[5,5],dec_blk_nums=[5,5],middle_blk_num=10).cuda()
