...
def make_model(args, parent=False):
    return HAUNet(up_scale=args.scale[0], width=64, enc_blk_nums=[5,5],dec_blk_nums=[5,5],middle_blk_num=10)
...
if __name__ == '__main__':
    ...
    net = HAUNet(up_scale=4, width=64, enc_blk_nums=[5,5],dec_blk_nums=[5,5],middle_blk_num=10).cuda()
